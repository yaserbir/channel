function run(msg)
	...
	about_key = {{{text = "کانال رسمی" , url = "https://telegram.me/qashqai1"}},{{text = "ربات تیم" , url = "https://telegram.me/turkchannel_bot"}},{{text = "پیام رسان" , url = "https://telegram.me/qashqai1_bot"}}}
...
`با استفاده از این کلید میتوانید نام کانال، یوزرنیم کانال، آی دی کانال، شماره ارتباطی با سامانه پیامکی، انقضای اکانت، آمار کانال، سازنده ی کانال، تعداد ادمینهای کانال، لیست ادمینهای کانال را در یک لیست ببینید.`]]
	...
	elseif msg.text == "مثال کیبرد اینلاین و مارک داون" then
		inlinekey = {{{text = "کانال تیم" , url = "https://telegram.me/qashqai1"}},{{text = "ربات تیم" , url = "https://telegram.me/qashqai1_bot"}}}
		text = "مثال استایل نویس با فونتهای مختلف:\n*qashqai1 Team*\nqashqai1 Team\n_qashqai1 Team_\n`qashqai1 Team`\nتیم قشقایی\n`تیم قشقایی`\nمثال هایپر لینک:\n[تیم قشقایی](telegram.me/qashqai1)\n[qashqai1 Team](telegram.me/qashqai1)\nمثال کیبرد اینلاین:"
